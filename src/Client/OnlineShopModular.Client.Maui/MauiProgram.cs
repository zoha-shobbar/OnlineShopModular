...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "OnlineShopModular.Client.Maui").Build();
                configuration.GetRequiredSection("Logging:Sentry").Bind(options);
            })
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "OnlineShopModular.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientPubSubMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "OnlineShopModular";
                });
            });
