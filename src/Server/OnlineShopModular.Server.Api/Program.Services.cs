...
using OnlineShopModular.Server.Api.Controllers;
using OnlineShopModular.Server.Shared.Services;
...
public static partial class Program
{
    public static void AddServerApiProjectServices(this WebApplicationBuilder builder)
    {
        ...
        services.AddScoped(sp =>
        {
            ...
            var options = new Fido2Configuration
            {
                ...
                ServerName = "OnlineShopModular WebAuthn",
        ...
        builder.Services.AddHangfire(configuration =>
        {
            var efCoreStorage = configuration.UseEFCoreStorage(optionsBuilder =>
            {
                ...
                {
                    var connectionString = "Data Source=OnlineShopModularJobs.db;Mode=Memory;Cache=Shared;";
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "OnlineShopModular.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "OnlineShopModular.Shared.xml"));
