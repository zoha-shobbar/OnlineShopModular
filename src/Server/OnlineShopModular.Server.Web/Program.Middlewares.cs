...
using OnlineShopModular.Server.Api.Filters;
using OnlineShopModular.Server.Api.Services;
using OnlineShopModular.Server.Web.Endpoints;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        {
            options.InjectJavascript($"/_content/OnlineShopModular.Server.Api/scripts/swagger-utils.js?v={Environment.TickCount64}");
        });
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("OnlineShopModular.Client") is true).ToArray());
