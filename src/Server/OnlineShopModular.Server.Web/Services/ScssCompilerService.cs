...
namespace OnlineShopModular.Server.Web.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShopModular.Client.Core");
        ...
        // but uses ../../Client/OnlineShopModular.Client.Web:../../Client/OnlineShopModular.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShopModular.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShopModular.Client.Maui/Components:../../Client/OnlineShopModular.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShopModular.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShopModular.Client.Windows/Components:../../Client/OnlineShopModular.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShopModular.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShopModular.Client.Web/Components:../../Client/OnlineShopModular.Client.Web/Components");
